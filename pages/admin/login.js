...
import { getAuth, signIn } from "../../services/redux/features/authSlice";
        ...
        <form className="mt-8 space-y-6">
          ...
          <div>
            <button
              ...
              className={
                !email || !password
                  ? `group relative flex w-full justify-center rounded-md border border-transparent bg-gray-400 py-2 px-4 text-sm font-medium text-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2`
